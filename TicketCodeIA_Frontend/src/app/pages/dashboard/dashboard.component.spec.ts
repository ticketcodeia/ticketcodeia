...
describe('DashboardComponent', () => {
  ...
  it('should load stats on init', () => {
    ...
    statsReq.flush({ total: 5, todo: 2, inProgress: 1, codeReview: 0, testing: 1, done: 1, escalated: 0 });
  ...
  it('should display stat cards', () => {
    ...
    httpTesting.expectOne('http://localhost:8080/api/tickets/stats')
      .flush({ total: 10, todo: 3, inProgress: 2, codeReview: 1, testing: 1, done: 2, escalated: 1 });
  ...
  it('should show "No recent activity" when empty', () => {
    ...
    httpTesting.expectOne('http://localhost:8080/api/tickets/stats')
      .flush({ total: 0, todo: 0, inProgress: 0, codeReview: 0, testing: 0, done: 0, escalated: 0 });
    httpTesting.expectOne('http://localhost:8080/api/sse/recent-activity').flush([]);
  ...
  it('should display h1 title', () => {
    fixture.detectChanges();
    httpTesting.expectOne('http://localhost:8080/api/tickets/stats').flush({ total: 0, todo: 0, inProgress: 0, codeReview: 0, testing: 0, done: 0, escalated: 0 });
    httpTesting.expectOne('http://localhost:8080/api/sse/recent-activity').flush([]);
